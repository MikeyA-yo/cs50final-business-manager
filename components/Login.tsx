    ...
    <>
      <div className={`flex bg-[#071952] items-center justify-center min-h-[100svh] ${inter.className}`}>
        ...
        <div className="h-screen w-full gap-2 flex items-center justify-center bg-[#EBF4F6] ">
            <Link href={`/api/auth/login`}><div className="bg-[#37B7C3] gap-2 p-2 shadow-lg shadow-[#088395] flex items-center justify-center"><GoogleSvg className="h-8 w-8" /> <span>Sign in With Google</span></div></Link>
        </div>
      </div>
    </>
 )
